    ...
    <div className="app__about">
      ...
      <div className="app__about-content-wrapper">
        ...
        <div className="app__about-page-section">
          <h2>{section_one_title}</h2>

          <p>{section_one_content_paragraph_one}</p>

          <p>{sections_one_content_paragraph_two}</p>
        </div>

        <div className="app__about-page-section">
          <h2>{section_two_title}</h2>

          <p>{section_two_paragraph_one}</p>

          <div className="app__about-p-title">{section_two_paragraph_two}</div>
        ...
        <div className="app__about-page-section">
          <h2>{section_three_title}</h2>

          <p>{section_three_paragraph_one}</p>
        ...
        <div className="app__about-page-section">
          <h2>{section_four_title}</h2>

          <p>{section_four_paragraph_one}</p>

          <div className="app__about-p-title">{section_four_paragraph_two}</div>
